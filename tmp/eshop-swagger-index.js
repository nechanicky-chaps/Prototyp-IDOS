...
window.onload = function () {
    var configObject = JSON.parse('{"urls":[{"url":"/api-v2/swagger.json","name":"Slu\u017Eba eShopWS - prodejn\u00ED API"},{"url":"/admin-v2/swagger.json","name":"Slu\u017Eba eShopWS - administra\u010Dn\u00ED API"},{"url":"/legacy/swagger.json","name":"Slu\u017Eba eShopWS - legacy API"}],"deepLinking":false,"persistAuthorization":false,"displayOperationId":false,"defaultModelsExpandDepth":1,"defaultModelExpandDepth":1,"defaultModelRendering":"example","displayRequestDuration":false,"docExpansion":"list","showExtensions":false,"showCommonExtensions":false,"supportedSubmitMethods":["get","put","post","delete","options","head","patch","trace"],"tryItOutEnabled":false}');
